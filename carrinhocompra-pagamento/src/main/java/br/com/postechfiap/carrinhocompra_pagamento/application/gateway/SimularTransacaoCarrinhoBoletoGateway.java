...
import br.com.postechfiap.carrinhocompra_pagamento.domain.usecases.repository.SimularTransacaoCarrinhoBoletoRepository;
...
public class SimularTransacaoCarrinhoBoletoGateway implements SimularTransacaoCarrinhoBoletoRepository {
    ...
    public SimularTransacaoCarrinhoBoletoGateway(
